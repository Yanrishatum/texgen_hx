...
class Main extends Sprite 
{
    ...
    createSample(TG.texture( 256, 256 )
      ...
      .add( TG.sinX().frequency( 0.004 ).color( 0.25, 0, 0 ) )
      .sub( TG.sinY().frequency( 0.004 ).color( 0.25, 0, 0 ) )
      .add( TG.sinX().frequency( 0.0065 ).color( 0.1, 0.5, 0.2 ) )
      .add( TG.sinY().frequency( 0.0065 ).color( 0, 0.4, 0.5 ) )
    ...
    createSample(TG.texture( 256, 256 )
      ...
      .div( TG.sinX().frequency( 0.02 ).color( 8, 5, 4 ) )
      .add( TG.noise().color( 0.1, 0, 0 ) )
      .add( TG.noise().color( 0, 0.1, 0 ) )
      .add( TG.noise().color( 0, 0, 0.1 ) ));
    ...
    createSample(TG.texture( 256, 256 )
    .add( TG.checkerBoard().size( 32, 32 ).color( 0.5, 0, 0 ) )
    .set( TG.twirl().radius( 128 ).strength ( 75 ) ));
    ...
    //
    createSample(TG.texture( 256, 256 )
    .add( TG.circle().position( 128, 128 ).radius( 64 ).delta( 60 ).color( 1, 0.25, 0.25 ) )
    .set( TG.pixelate().size( 8, 8 ) ));

    //
    createSample(TG.texture( 256, 256 )
      .add( TG.checkerBoard().color( 1, 1, 0 ) )
      .set( TG.transform().offset( 10, 20 ).angle( 23 ).scale( 2, 0.5 ) ));

    //
    createSample(TG.texture( 256, 256 )
      .add( TG.checkerBoard() )
      .and( TG.circle().position( 128, 128 ).radius( 80 ) )
      .xor( TG.circle().position( 128, 128 ).radius( 64 ) ));
	}
